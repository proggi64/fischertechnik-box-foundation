...
- [__getBoxUsageHeight__](Base/getBoxUsageHeight.md): Liefert nutzbare innere Höhe eines Sortierkastens
- [__getBoxWallThickness__](Base/getBoxWallThickness.md): Liefert Stärke der Wände eines Sortierkastens
- [__getBoxWebWidth__](Base/getBoxWebWidth.md): Liefert Standardlänge eines Stegs für Sortierkästen
